...
class ComplexListActivity : AppCompatActivity() {
    ...
    private lateinit var adapter: ListAdapter  // Asegúrate de inicializar esto correctamente
    ...
    fun cargaContactos() {
        ...
        adapter = ListAdapter(this, ids, nombres, apellidos, correos, celulares)  // Inicializa el adaptador aquí
        lstComp.adapter = adapter
    }
    ...
    private val requestPermissionLauncher = registerForActivityResult(
        ...
        if (isGranted) {
            ...
            showToast("Se requieren permisos")
        }
    }
