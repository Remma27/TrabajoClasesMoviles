...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var agregarContacto: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        agregarContacto = findViewById(R.id.agregarContacto)

        btnSimplex.setOnClickListener {
        ...
        agregarContacto.setOnClickListener {
            val intent = Intent(applicationContext, AgregarContacto::class.java)
            startActivity(intent)
        }
    }
